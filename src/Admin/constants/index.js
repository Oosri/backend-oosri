module.exports = {
  ...
  adminProductMessage: {
    ...
    PRODUCT_ACTION:
      'Invalid action, you are only allowed to approve or reject a product',
  ...
  adminAuthMessage: {
    ...
    WEAK_PASSWORD:
      'Weak password. Password must Contain at Least 8 Characters Including Uppercase, Lowercase and Digit',
  ...
  adminOrderMessage: {
    ...
    UNAUTHORIZED_ORDER:
      'Order not found or not authorized to cancel this order',
