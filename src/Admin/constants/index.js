module.exports = {
  ...
  returnMessage: {
    SETTINGS_FETCHED: 'Return settings fetched successfully',
    SETTINGS_UPDATED: 'Return settings updated successfully',
    REQUEST_CREATED: 'Return request submitted successfully',
    REQUEST_FETCHED: 'Return request(s) fetched successfully',
    REQUEST_NOT_FOUND: 'Return request not found',
    WINDOW_EXPIRED: 'The return window for this order has expired',
    FEATURE_DISABLED: 'Return & refund feature is currently disabled',
    ALREADY_REQUESTED: 'A return request already exists for this order',
    ORDER_NOT_ELIGIBLE: 'This order is not eligible for return',
    INVALID_TRANSITION: 'Invalid status transition',
    REFUND_INITIATED: 'Refund has been initiated',
    REFUND_COMPLETED: 'Refund completed successfully',
    GATEWAY_ERROR: 'Failed to process refund via payment gateway',
  },
  kycMessage: {
    KYC_SUBMITTED: 'KYC documents submitted successfully',
    KYC_UPDATED: 'KYC documents updated successfully',
    KYC_FETCHED: 'KYC applications fetched successfully',
    KYC_FETCHED_BY_ID: 'KYC application fetched successfully',
    KYC_APPROVED: 'KYC application approved successfully',
    KYC_REJECTED: 'KYC application rejected',
    KYC_NOT_FOUND: 'KYC application not found',
    KYC_ALREADY_APPROVED: 'KYC is already approved',
    KYC_FETCH_ERROR: 'Failed to fetch KYC applications',
    SELLER_NOT_FOUND: 'Seller not found',
    NO_DOCUMENTS: 'At least one document must be provided',
  },
  databaseMessage: {
